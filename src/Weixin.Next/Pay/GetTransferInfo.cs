...
namespace Weixin.Next.Pay
{
    ...
    {
        public GetTransferInfo(Requester requester, bool checkSignature, bool sandbox, bool generateReport)
        ...
        {
            interface_url = ApiRootUrl + "mmpaymkttransfers/gettransferinfo";
            requiresCert = true;
        }
